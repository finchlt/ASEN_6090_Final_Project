function eph = read_rinex_nav(ephemerisfile)

%READ_RINEX_NAV Reads a RINEX Navigation Message file and
...
% Modified eph = rinexe('pta.96n');
% 2009 P. Axelrad
% Modification to just return ephemeris in an array and skip the output
% file.
% 2010 Function name changed from rinexe.m to read_rinex_nav (for clarity)
